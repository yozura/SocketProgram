...
#define SIZE_DAT		(SIZE_TOT - sizeof(int))	// 헤더를 제외한 데이터 부분의 크기

#define TYPE_CHAT		1000						// 메시지 타입 : 채팅
#define TYPE_DRAWLINE	1001						// 메시지 타입 : 그리기
#define TYPE_ERASEPIC	1002						// 메시지 타입 : 지우기

#define WM_DRAWLINE		(WM_USER + 1)				// 사용자 정의 윈도우 메시지 (그리기)
#define WM_ERASEPIC		(WM_USER + 2)				// 사용자 정의 윈도우 메시지 (지우기)
